...
if __name__ == '__main__':
    print(my_list)  # Initially, the list is [1, 2, 3, 4, 5]
    add_item_to_list(my_list)
    add_item_to_list(my_list)
    add_item_to_list(my_list)
    print(my_list)  # After adding 3 items, list should be [1, 2, 3, 4, 5, 6, 7, 8]
    remove_items_from_list(my_list, [1, 5, 6])
    print(my_list)  # After removing 1, 5, and 6, list should be [2, 3, 4, 7, 8]
